...
class autorLibroSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('autor_libro')->insert([
            ...
            'libro_id' => 1, // ID del libro Las mil y una noches
        ...
        DB::table('autor_libro')->insert([
            ...
            'libro_id' => 2, // ID del libro Cien años de soledad
        ...
        DB::table('autor_libro')->insert([
            ...
            'libro_id' => 4, // ID del libro Veinte poemas de amor y una canción desesperada
        ...
        DB::table('autor_libro')->insert([
            ...
            'libro_id' => 5, // ID del libro Breve historia del tiempo
